...
2 周目の P5 で新たに挙がった非ブロッキングの文言 2 件は、ユーザーの判断により本 PR で直した。反復上限に達しているため、この 2 件は P5 の再確認を受けていない。

人間に残るのは 11 thread の resolve と PR の merge。
