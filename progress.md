...
| OPS-02 | [#70](https://github.com/kiyohara/bizdate/issues/70) | done | なし | cloud session で `gh` を使えるようにする。network の許可リストへの host の追加も判断する || [#74](https://github.com/kiyohara/bizdate/pull/74) |
