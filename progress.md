...
| DIST-03a | [#64](https://github.com/kiyohara/bizdate/issues/64) | todo | #38 | 配布対象から Intel Mac（`x86_64-apple-darwin`）を外す | - |
...
- `run-issue-task` で #64 へ進む。配布対象から Intel Mac を外す。続いて #65、#39 の順に進める。
